<?php 
/**
 * Template part for displaying gallery item.
 * 
 * @package wpg_photo
 * @since 1.0.0
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content col-7" style="float:right;">
		...
		?>	
		<?php if( get_post_meta(get_the_ID(), 'wpg_link_offer', true) ) : $link_offer = get_post_meta(get_the_ID(), 'wpg_link_offer', true); ?>
			<div class="col-6">
				<a href="<?php echo esc_url(get_permalink(intval($link_offer))); ?>" class="relation-link"><?php _e('Show Offer','wpg_theme'); ?></a>							
			</div>
		<?php endif; //wpg_link_offer ?>
	...
	<?php if ( has_post_thumbnail() ) { ?>
		<figure class="entry-image post-thumbnail col-5 hidde-tablet">
