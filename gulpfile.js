...
// Base config
var project 	=	'wpg-photo', 			// The directory name for your theme
	node 		=	'node_modules/',
...
var config = {
	assets_js: {
    	...
    	//imagesload:	bower + 'imagesloaded/imagesloaded.pkgd.min.js',
    	//masonry:	bower + 'masonry/dist/masonry.pkgd.min.js',     
...
gulp.task('theme-js',function(){
	...
	gulp.src([
		config.assets_js.html5shiv,
		config.assets_js.slick_js,
		])
 ...
 */
	...
	// 5.	Build stylesheets	
	gulp.watch(config.theme.css.src +'/**/*.scss', ['css']);
 	//6.	Copy images
